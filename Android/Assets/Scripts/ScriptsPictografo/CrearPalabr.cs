...
public class CrearPalabr : MonoBehaviour
{
    public Text TextScore;

    public static CrearPalabr Gamecontroller;
    public static String scorePictografo = "";

    private void Update()
    {
        if (scorePictografo.Equals("pictografo"))
        {
    ...
    void ReadDatabase()
    {
        ...
        while (reader.Read())
        {
            ...
            TextScore.text += "\n" + reader.GetValue(2) + scorePictografo.ToString();
        }
        reader.Close();
        reader = null;
        dbcmd.Dispose();
